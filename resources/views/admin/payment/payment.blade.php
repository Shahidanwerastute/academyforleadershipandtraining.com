...
@section('content')
	...
	<div id="page_content">
		<div id="page_content_inner">
			<h3 class="heading_b uk-margin-bottom">Courses Payments</h3>
			<div class="md-card">
...
@push('js')	
	...
	{{ HTML::script('public/assets/admin/js/pages/payment/index.js?v=2.1')}}
@endpush
@push('metainfo');
	<title>Courses Payments | {{ config('app.name') }}</title>
@endpush