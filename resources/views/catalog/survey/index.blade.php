...
@section('content')
	...
	@if ($data['survey_already_submitted'])
		<div class="questionnaireEd" style="margin-top: 250px;">
			...
			<div id="fullpage" class="questionnaireEd">
					...
					@if($data['company']->limit == Null || $data['survey']->count < $data['company']->limit)
						<div class="container welcome-box">
							<header class="header">
								...
								<h4>Here are a few tips to consider while you take this assessment:</h4>
							...
							<div class="row">
								<div class="col-sm-6">
									<div class="form-group">
										<h2>First Name*</h2>
										{{ Form::text('first_name', (Route::is('catalog-survey-form') || Route::is('catalog-survey-friend-assessment-form') ? $data['employee']->first_name : ''), array('placeholder' => 'First Name', 'autocomplete' => 'off' ,'class' => 'form-control require allowTab', (Route::is('catalog-survey-form') || Route::is('catalog-survey-friend-assessment-form') ? 'readonly' : ''))) }}
								...
								<div class="col-sm-6">
									<div class="form-group">
										<h2>Last Name*</h2>
										{{ Form::text('last_name', (Route::is('catalog-survey-form') || Route::is('catalog-survey-friend-assessment-form') ? $data['employee']->last_name : ''), array('placeholder' => 'Last Name', 'autocomplete' => 'off' , 'class' => 'form-control require allowTab', (Route::is('catalog-survey-form') || Route::is('catalog-survey-friend-assessment-form') ? 'readonly' : ''))) }}
								...
								<div class="col-sm-6">
									<div class="form-group">
										<h2>Email*</h2>
										{{ Form::text('email', (Route::is('catalog-survey-form') || Route::is('catalog-survey-friend-assessment-form') ? $data['employee']->email : ''), array('placeholder' => 'Email', 'autocomplete' => 'off', 'class' => 'form-control require allowTab', (Route::is('catalog-survey-form') || Route::is('catalog-survey-friend-assessment-form') ? 'readonly' : ''))) }}
				...
				<div class="section start-point inactive">
					<header class="header">
						<div class="container">
							<h1>Thank You</h1>
							@if(Route::is('catalog-rootpath-ab'))
