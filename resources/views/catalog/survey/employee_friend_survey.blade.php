			...
			-->
				@if($data['company']->limit == Null || $data['survey']->count < $data['company']->limit)
					<div class="container welcome-box">
						<header class="header">
							<h1>Welcome to the Communication Styles Assessment</h1>
							<h4>Here is a tip to consider while you take this assessment:</h4>

							<div class="row">
								<ul>
									@if(!Route::is('catalog-survey-friend-assessment-form') && !Route::is('catalog-survey-employee-assessment-form') && !Route::is('catalog-survey-employee-friend-assessment-form'))
										<li>Think of yourself at work</li>
										<li>Think about how others would describe you</li>
									@elseif(Route::is('catalog-survey-employee-assessment-form') || Route::is('catalog-survey-employee-friend-assessment-form'))
										<li>Please consider "{{$data['employee']->first_name.' '.$data['employee']->last_name}}" as they are at work, when answering these questions.</li>
									@else
			...
			<div class="section employeeForm start-point required">
				...
				<header class="header over-scroll">
					<div class="container">
						...
						<div class="row">
							<div class="col-sm-12">
								<h4>Below is the information of the individual you are about to rate.</h4>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									<h2>First Name*</h2>
									{{ Form::text('first_name', (Route::is('catalog-survey-form') || Route::is('catalog-survey-friend-assessment-form') || Route::is('catalog-survey-employee-assessment-form') || Route::is('catalog-survey-employee-friend-assessment-form') ? $data['employee']->first_name : ''), array('placeholder' => 'First Name', 'autocomplete' => 'off' ,'class' => 'form-control require allowTab', (Route::is('catalog-survey-form') || Route::is('catalog-survey-friend-assessment-form') || Route::is('catalog-survey-employee-friend-assessment-form') ? 'readonly' : ''))) }}
							...
							<div class="col-sm-6">
								<div class="form-group">
									<h2>Last Name*</h2>
									{{ Form::text('last_name', (Route::is('catalog-survey-form') || Route::is('catalog-survey-friend-assessment-form') || Route::is('catalog-survey-employee-assessment-form') || Route::is('catalog-survey-employee-friend-assessment-form') ? $data['employee']->last_name : ''), array('placeholder' => 'Last Name', 'autocomplete' => 'off' , 'class' => 'form-control require allowTab', (Route::is('catalog-survey-form') || Route::is('catalog-survey-friend-assessment-form') || Route::is('catalog-survey-employee-friend-assessment-form') ? 'readonly' : ''))) }}
							...
							<div class="col-sm-6">
								<div class="form-group">
									<h2>Email*</h2>
									{{ Form::text('email', (Route::is('catalog-survey-form') || Route::is('catalog-survey-friend-assessment-form') || Route::is('catalog-survey-employee-assessment-form') || Route::is('catalog-survey-employee-friend-assessment-form') ? $data['employee']->email : ''), array('placeholder' => 'Email', 'autocomplete' => 'off', 'class' => 'form-control require allowTab', (Route::is('catalog-survey-form') || Route::is('catalog-survey-friend-assessment-form') || Route::is('catalog-survey-employee-friend-assessment-form') ? 'readonly' : ''))) }}
			...
			@foreach($data['survey']->questions() as $ki => $row)
				...
				@if($row->type == 'radio')
					<div class="section radioBoxes start-point inactive {{($row->require == 1 ? 'required' : '').' '.($row->is_extra == 1 ? $row->extra_class : '')}}">
						<header class="header over-scroll">
							<div class="container">
								<h4>Note: - Think about how you would answer the questions as they relate to "{{$data['employee']->first_name.' '.$data['employee']->last_name}}".</h4>
