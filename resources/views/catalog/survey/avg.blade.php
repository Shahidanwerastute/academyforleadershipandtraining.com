...
<!--
									...
									<div class="col-xs-6">
										<div class="box _b-bg">
											...
											<div class="box-active">
												<div class="img-title">{{$data['submission']->first_name.' '.$data['submission']->last_name}}<br>Self Assessment</div>
												<figure>
													{{HTML::image('public/assets/catalog/images/check.png')}}
												</figure>
												@if($data['friend_assessment_record']->behavior == "Analytical" && $data['record']->behavior == "Analytical")
													<div class="img-title mt-4">Raters' Average</div>
												@endif
											</div>
											@endif
											@if($data['friend_assessment_record']->behavior == "Analytical" && $data['record']->behavior != "Analytical")
												<div class="box-active">
													<div class="img-title">Raters' Average</div>
													<figure>
														{{HTML::image('public/assets/catalog/images/check.png')}}
													</figure>
												</div>
									...
									<div class="col-xs-6">
										<div class="box _a-bg">
											...
											<div class="box-active">
												...
												@if($data['friend_assessment_record']->behavior == "Driver" && $data['record']->behavior == "Driver")
													<div class="img-title mt-4">Raters' Average</div>
												@endif
											</div>
											@endif
									...
									<div class="col-xs-6">
										<div class="box _r-bg">
											...
											<div class="box-active">
												...
												@if($data['friend_assessment_record']->behavior == "Amiable" && $data['record']->behavior == "Amiable")
													<div class="img-title mt-4 mt-3">Raters' Average</div>
												@endif
											</div>
											@endif
											@if($data['friend_assessment_record']->behavior == "Amiable" && $data['record']->behavior != "Amiable")
									...
									<div class="col-xs-6">
										<div class="box _l-bg">
											...
											<div class="box-active">
												...
												@if($data['friend_assessment_record']->behavior == "Expressive" && $data['record']->behavior == "Expressive")
													<div class="img-title mt-4">Raters' Average</div>
												@endif
											</div>
											@endif
												...
												<div class="box _b-bg">
													@if($data['record']->behavior == "Analytical" && $data['sub_quadrant']->behavior == "AN")
														<div class="box-active-1">
															<div class="img-title-1">{{$data['submission']->first_name.' '.$data['submission']->last_name}}<br>Self Assessment</div>
															<figure>
																{{HTML::image('public/assets/catalog/images/check.png')}}
															</figure>
															@if($data['friend_assessment_record']->behavior == "Analytical" && $data['friend_assessment_sub_quadrant']->behavior == "AN" && ($data['record']->behavior == "Analytical" && $data['sub_quadrant']->behavior == "AN"))
																<div class="img-title-1 mt-4">Raters' Average</div>
															@endif
														</div>
													@elseif($data['friend_assessment_record']->behavior == "Analytical" && $data['friend_assessment_sub_quadrant']->behavior == "AN")
														<div class="box-active-1">
															<div class="img-title-1">Raters' Average</div>
															<figure>
																{{HTML::image('public/assets/catalog/images/check.png')}}
															</figure>
														</div>
												...
												<div class="box _b-bg">
													@if($data['record']->behavior == "Analytical" && $data['sub_quadrant']->behavior == "DR")
														<div class="box-active-1">
															...
															@if($data['friend_assessment_record']->behavior == "Analytical" && $data['friend_assessment_sub_quadrant']->behavior == "DR" && ($data['record']->behavior == "Analytical" && $data['sub_quadrant']->behavior == "DR"))
																<div class="img-title-1 mt-4">Raters' Average</div>
															@endif
														</div>
													@elseif($data['friend_assessment_record']->behavior == "Analytical" && $data['friend_assessment_sub_quadrant']->behavior == "DR")
														<div class="box-active-1">
															<div class="img-title-1">Raters' Average</div>
															<figure>
																{{HTML::image('public/assets/catalog/images/check.png')}}
												...
												<div class="box _b-bg">
													@if($data['record']->behavior == "Analytical" && $data['sub_quadrant']->behavior == "AM")
														<div class="box-active-1">
															...
															@if($data['friend_assessment_record']->behavior == "Analytical" && $data['friend_assessment_sub_quadrant']->behavior == "AM" && $data['record']->behavior == "Analytical" && $data['sub_quadrant']->behavior == "AM")
																<div class="img-title-1 mt-4">Raters' Average</div>
															@endif
														</div>
													@elseif($data['friend_assessment_record']->behavior == "Analytical" && $data['friend_assessment_sub_quadrant']->behavior == "AM")
														<div class="box-active-1">
															<div class="img-title-1">Raters' Average</div>
															<figure>
																{{HTML::image('public/assets/catalog/images/check.png')}}
												...
												<div class="box _b-bg">
													@if($data['record']->behavior == "Analytical" && $data['sub_quadrant']->behavior == "EX")
														<div class="box-active-1">
															...
															@if($data['friend_assessment_record']->behavior == "Analytical" && $data['friend_assessment_sub_quadrant']->behavior == "EX" && ($data['record']->behavior == "Analytical" && $data['sub_quadrant']->behavior == "EX"))
																<div class="img-title-1 mt-4">Raters' Average</div>
															@endif
														</div>
													@elseif($data['friend_assessment_record']->behavior == "Analytical" && $data['friend_assessment_sub_quadrant']->behavior == "EX")
														<div class="box-active-1">
															<div class="img-title-1">Raters' Average</div>
															<figure>
																{{HTML::image('public/assets/catalog/images/check.png')}}
												...
												<div class="box _a-bg">
													@if($data['record']->behavior == "Driver" && $data['sub_quadrant']->behavior == "AN")
														<div class="box-active-1">
															...
															@if($data['friend_assessment_record']->behavior == "Driver" && $data['friend_assessment_sub_quadrant']->behavior == "AN" && ($data['record']->behavior == "Driver" && $data['sub_quadrant']->behavior == "AN"))
																<div class="img-title-1 mt-4">Raters' Average</div>
															@endif
														</div>
													@elseif($data['friend_assessment_record']->behavior == "Driver" && $data['friend_assessment_sub_quadrant']->behavior == "AN")
														<div class="box-active-1">
															<div class="img-title-1">Raters' Average</div>
															<figure>
																{{HTML::image('public/assets/catalog/images/check.png')}}
												...
												<div class="box _a-bg">
													@if($data['record']->behavior == "Driver" && $data['sub_quadrant']->behavior == "DR")
														<div class="box-active-1">
															...
															@if($data['friend_assessment_record']->behavior == "Driver" && $data['friend_assessment_sub_quadrant']->behavior == "DR" && ($data['record']->behavior == "Driver" && $data['sub_quadrant']->behavior == "DR"))
																<div class="img-title-1 mt-4">Raters' Average</div>
															@endif
														</div>
													@elseif($data['friend_assessment_record']->behavior == "Driver" && $data['friend_assessment_sub_quadrant']->behavior == "DR")
														<div class="box-active-1">
															<div class="img-title-1">Raters' Average</div>
															<figure>
																{{HTML::image('public/assets/catalog/images/check.png')}}
												...
												<div class="box _a-bg">
													@if($data['record']->behavior == "Driver" && $data['sub_quadrant']->behavior == "AM")
														<div class="box-active-1">
															...
															@if($data['friend_assessment_record']->behavior == "Driver" && $data['friend_assessment_sub_quadrant']->behavior == "AM" && ($data['record']->behavior == "Driver" && $data['sub_quadrant']->behavior == "AM"))
																<div class="img-title-1 mt-4">Raters' Average</div>
															@endif
														</div>
													@elseif($data['friend_assessment_record']->behavior == "Driver" && $data['friend_assessment_sub_quadrant']->behavior == "AM")
														<div class="box-active-1">
															<div class="img-title-1">Raters' Average</div>
															<figure>
																{{HTML::image('public/assets/catalog/images/check.png')}}
												...
												<div class="box _a-bg">
													@if($data['record']->behavior == "Driver" && $data['sub_quadrant']->behavior == "EX")
														<div class="box-active-1">
															...
															@if($data['friend_assessment_record']->behavior == "Driver" && $data['friend_assessment_sub_quadrant']->behavior == "EX" && ($data['record']->behavior == "Driver" && $data['sub_quadrant']->behavior == "EX"))
																<div class="img-title-1 mt-4">Raters' Average</div>
															@endif
														</div>
													@elseif($data['friend_assessment_record']->behavior == "Driver" && $data['friend_assessment_sub_quadrant']->behavior == "EX")
														<div class="box-active-1">
															<div class="img-title-1">Raters' Average</div>
															<figure>
																{{HTML::image('public/assets/catalog/images/check.png')}}
												...
												<div class="box _r-bg">
													@if($data['record']->behavior == "Amiable" && $data['sub_quadrant']->behavior == "AN")
														<div class="box-active-1">
															...
															@if($data['friend_assessment_record']->behavior == "Amiable" && $data['friend_assessment_sub_quadrant']->behavior == "AN" && ($data['record']->behavior == "Amiable" && $data['sub_quadrant']->behavior == "AN"))
																<div class="img-title-1 mt-4">Raters' Average</div>
															@endif
														</div>
													@elseif($data['friend_assessment_record']->behavior == "Amiable" && $data['friend_assessment_sub_quadrant']->behavior == "AN" && ($data['record']->behavior != "Amiable" && $data['sub_quadrant']->behavior != "AN"))
														<div class="box-active-1">
															<div class="img-title-1">Raters' Average</div>
															<figure>
																{{HTML::image('public/assets/catalog/images/check.png')}}
												...
												<div class="box _r-bg">
													@if($data['record']->behavior == "Amiable" && $data['sub_quadrant']->behavior == "DR")
														<div class="box-active-1">
															...
															@if($data['friend_assessment_record']->behavior == "Amiable" && $data['friend_assessment_sub_quadrant']->behavior == "DR" && ($data['record']->behavior == "Amiable" && $data['sub_quadrant']->behavior == "DR"))
																<div class="img-title-1 mt-4">Raters' Average</div>
															@endif
														</div>
													@elseif($data['friend_assessment_record']->behavior == "Amiable" && $data['friend_assessment_sub_quadrant']->behavior == "DR")
														<div class="box-active-1">
															<div class="img-title-1">Raters' Average</div>
															<figure>
																{{HTML::image('public/assets/catalog/images/check.png')}}
												...
												<div class="box _r-bg">
													@if($data['record']->behavior == "Amiable" && $data['sub_quadrant']->behavior == "AM")
														<div class="box-active-1">
															...
															@if($data['friend_assessment_record']->behavior == "Amiable" && $data['friend_assessment_sub_quadrant']->behavior == "AM" && ($data['record']->behavior == "Amiable" && $data['sub_quadrant']->behavior == "AM"))
																<div class="img-title-1 mt-4">Raters' Average</div>
															@endif
														</div>
													@elseif($data['friend_assessment_record']->behavior == "Amiable" && $data['friend_assessment_sub_quadrant']->behavior == "AM")
														<div class="box-active-1">
															<div class="img-title-1">Raters' Average</div>
															<figure>
																{{HTML::image('public/assets/catalog/images/check.png')}}
												...
												<div class="box _r-bg">
													@if($data['record']->behavior == "Amiable" && $data['sub_quadrant']->behavior == "EX")
														<div class="box-active-1">
															...
															@if($data['friend_assessment_record']->behavior == "Amiable" && $data['friend_assessment_sub_quadrant']->behavior == "EX" && ($data['record']->behavior == "Amiable" && $data['sub_quadrant']->behavior == "EX"))
																<div class="img-title-1 mt-4">Raters' Average</div>
															@endif
														</div>
													@elseif($data['friend_assessment_record']->behavior == "Amiable" && $data['friend_assessment_sub_quadrant']->behavior == "EX" && ($data['record']->behavior != "Amiable" && $data['sub_quadrant']->behavior != "EX"))
														<div class="box-active-1">
															<div class="img-title-1">Raters' Average</div>
															<figure>
																{{HTML::image('public/assets/catalog/images/check.png')}}
												...
												<div class="box _l-bg">
													@if($data['record']->behavior == "Expressive" && $data['sub_quadrant']->behavior == "AN")
														<div class="box-active-1">
															...
															@if($data['friend_assessment_record']->behavior == "Expressive" && $data['friend_assessment_sub_quadrant']->behavior == "AN" && ($data['record']->behavior == "Expressive" && $data['sub_quadrant']->behavior == "AN"))
																<div class="img-title-1 mt-4">Raters' Average</div>
															@endif
														</div>
													@elseif($data['friend_assessment_record']->behavior == "Expressive" && $data['friend_assessment_sub_quadrant']->behavior == "AN")
														<div class="box-active-1">
															<div class="img-title-1">Raters' Average</div>
															<figure>
																{{HTML::image('public/assets/catalog/images/check.png')}}
												...
												<div class="box _l-bg">
													@if($data['record']->behavior == "Expressive" && $data['sub_quadrant']->behavior == "DR")
														<div class="box-active-1">
															...
															@if($data['friend_assessment_record']->behavior == "Expressive" && $data['friend_assessment_sub_quadrant']->behavior == "DR" && ($data['record']->behavior == "Expressive" && $data['sub_quadrant']->behavior == "DR"))
																<div class="img-title-1 mt-4">Raters' Average</div>
															@endif
														</div>
													@elseif($data['friend_assessment_record']->behavior == "Expressive" && $data['friend_assessment_sub_quadrant']->behavior == "DR")
														<div class="box-active-1">
															<div class="img-title-1">Raters' Average</div>
															<figure>
																{{HTML::image('public/assets/catalog/images/check.png')}}
												...
												<div class="box _l-bg">
													@if($data['record']->behavior == "Expressive" && $data['sub_quadrant']->behavior == "AM")
														<div class="box-active-1">
															...
															@if($data['friend_assessment_record']->behavior == "Expressive" && $data['friend_assessment_sub_quadrant']->behavior == "AM" && ($data['record']->behavior == "Expressive" && $data['sub_quadrant']->behavior == "AM"))
																<div class="img-title-1 mt-4">Raters' Average</div>
															@endif
														</div>
													@elseif($data['friend_assessment_record']->behavior == "Expressive" && $data['friend_assessment_sub_quadrant']->behavior == "AM")
														<div class="box-active-1">
															<div class="img-title-1">Raters' Average</div>
															<figure>
																{{HTML::image('public/assets/catalog/images/check.png')}}
												...
												<div class="box _l-bg">
													@if($data['record']->behavior == "Expressive" && $data['sub_quadrant']->behavior == "EX")
														<div class="box-active-1">
															...
															@if($data['friend_assessment_record']->behavior == "Expressive" && $data['friend_assessment_sub_quadrant']->behavior == "EX" && ($data['record']->behavior == "Expressive" && $data['sub_quadrant']->behavior == "EX"))
																<div class="img-title-1 mt-4">Raters' Average</div>
															@endif
														</div>
													@elseif($data['friend_assessment_record']->behavior == "Expressive" && $data['friend_assessment_sub_quadrant']->behavior == "EX")
														<div class="box-active-1">
															<div class="img-title-1">Raters' Average</div>
															<figure>
																{{HTML::image('public/assets/catalog/images/check.png')}}
			...
			<section>
				<div class="_f-page-inner">
					<div class="sec-m-heading">360 Assessment: Your Raters' Perceptions</div>
					<div class="refd">
						{!! $data['rater_email_fields']->field_2 !!}
					</div>
					<div class="footer">
			...
			<section>
				<div class="_f-page-inner">
					...
					<div class="form-des">
						...
						<p><a href="mailto:jim@taflat.com">Jim@TAFLAT.com</a></p>
