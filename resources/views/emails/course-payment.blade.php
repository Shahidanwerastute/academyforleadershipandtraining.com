                            ...
                            <tr>
                                <td style="padding: 45px 35px;">
                                    <table style="display: block;width: 100%;">
                                        ...
                                        ">
                                                    @if($data['type'] == "user")
														Dear {{session()->get('personal-data.title').' '.session()->get('personal-data.name')}}, <br><br>
                                                    ...
                                                    This registration is also saved in the back-end. "{{session()->get('personal-data.title').' '.session()->get('personal-data.name')}}" has paid online for this course.
                                                    @endif
                                                    <p>&nbsp;</p>
                                                    <p> Name: {{session()->get('personal-data.title').' '.session()->get('personal-data.name')}}</p>
                                                    <p> Email: {{session()->get('personal-data.email')}}</p>
                                                    <p> Address: {{session()->get('personal-data.address')}}</p>
                                                    <p> Mobile: {{session()->get('personal-data.mobile')}}</p>
                                                    <p> Phone: {{session()->get('personal-data.phone')}}</p>
                                                    <p> Organization: {{session()->get('personal-data.organization')}}</p>
                                                    <p> Message: {{session()->get('personal-data.comment')}}</p>
