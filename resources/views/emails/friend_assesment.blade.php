                                ...
                                <tbody style="display: block;width: 100%;">
									<tr style="display: block;width: 100%;">
                                        <td style="
                                            ...
                                            word-spacing: 1px;
                                        ">
											<b>Dear {{$data['friend']->name}},</b><br><br>
                                        </td>
                                    </tr>
									<tr style="display: block;width: 100%;">
                                        <td style="
                                            ...
                                            word-spacing: 1px;
                                        ">
										<p>Please answer the questions, as you think {{$data['employee']->first_name.' '.$data['employee']->last_name}} would answer them, or from what you know about {{$data['employee']->first_name.' '.$data['employee']->last_name}}</p>
										<p><a href="{{route('catalog-survey-friend-assessment-form', [$data['friend']->id])}}">Click here to start Assessment</a></p>
                                        </td>
                                    </tr>	
									<tr><td>&nbsp;</td></tr>			
                                </tbody>
