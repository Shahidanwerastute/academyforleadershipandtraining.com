                                ...
                                <td style="padding: 45px 35px;">
                                    <table style="display: block;width: 100%;">
                                        <tbody style="display: block;width: 100%;">
                                            ...
                                            word-spacing: 1px;
                                        ">
                                                    Following is the inquiry received for the {!! preg_replace('/\s+\([^\)]+\)/', '', $data['course']->title) !!}!
													
													<p>&nbsp;</p>
                                                    <p>Name: {{request()->get('title').' '.request()->get('name')}}</p>
                                                    <p>Email: {{request()->get('email')}}</p>
                                                    <p>Address: {{request()->get('address')}}</p>
                                                    <p>Mobile: {{request()->get('mobile')}}</p>
                                                    <p>Phone: {{request()->get('phone')}}</p>
                                                    <p>Organization: {{request()->get('organization')}}</p>
                                                    <p>Message: {{request()->get('comment')}}</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>&nbsp;</td>
